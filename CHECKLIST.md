...
Last verified **2026-09-04** at commit `d9d407c`+.
...
### Infrastructure
- [x] Repository restored from bundle, **7 commits, pushed** to `github.com/Shahriar290900/Lumos`
...
- [x] **373 canonical chunks** — 290 from 180 legacy records (re-chunked) + 83 exam questions
...
- [x] **Bangla damage repaired** — 2,212 repairs across all 120 ICT records (BLOCK-009 resolved)
- [x] **English re-chunked** — 43 records → 109 chunks, none over the 600-token window
- [x] Cleaning is 4 separate reversible stages, each with its own tests
...
### Test surface
- [x] **179 tests** — identical count locally and in CI
...
6 of 33 goals complete. `[~]` in progress · `[!]` blocked on a human decision.

### Phase 0.5 — curriculum and data foundation
- [ ] **LUMOS-004C.2** Mark-scheme and examiner-report adapters, cross-document linking, and the document delivery column (ADR-026) ← **NEXT**
...
- [x] Bangla damage: repair or re-extract (BLOCK-009) — **resolved by repair**; the source PDFs are not needed
